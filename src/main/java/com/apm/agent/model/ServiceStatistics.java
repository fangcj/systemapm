...
public class ServiceStatistics extends BaseStatistics implements java.io.Serializable {
	...
	public String toString() {
		return "ServiceStatistics [begin=" + begin + ", end=" + end
				+ ", useTime=" + useTime + ", errorMsg=" + errorMsg
				+ ", errorType=" + errorType + ", serviceName=" + serviceName
				+ ", simpleName=" + simpleName + ", methodName=" + methodName
				+ "]";
	}
}
